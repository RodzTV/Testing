...
int main(void)
{
    ...
    int length2, width2, number2;
    double cost2, labor2, discount2, installed_price2, subtotal2, tax2, total_price2, carpet_cost2, area_cost2;
    int length3, width3, number3;
    double cost3, labor3, discount3, installed_price3, subtotal3, tax3, total_price3, carpet_cost3, area_cost3;
    ...
    length2 = readDataLength();
    width2 = readDataWidth();
    discount2 = readDataDiscount();
    cost2 = readDataCost();

    installed_price2 = calculateInstalledPrice(length2, width2, cost2);
    labor2 = LABOR_COST * (length2 * width2);
    subtotal2 = calculateSubtotal(installed_price2, discount2);
    tax2 = subtotal2 * TAX_RATE;
    total_price2 = calculateTotalPrice(subtotal2, tax2);
    carpet_cost2 = cost2 * (length2 * width2); 
    area_cost2 = cost2 * (length2 * width2);  
    
    
    printMeasurements(length2, width2);
    printCharges(cost2, labor2, installed_price2, discount2, subtotal2, tax2, total_price2, area_cost2);

    

    length3 = readDataLength();
    width3 = readDataWidth();
    discount3 = readDataDiscount();
    cost3 = readDataCost();

    installed_price3 = calculateInstalledPrice(length3, width3, cost3);
    labor3 = LABOR_COST * (length3 * width3);
    subtotal3 = calculateSubtotal(installed_price3, discount3);
    tax3 = subtotal3 * TAX_RATE;
    total_price3 = calculateTotalPrice(subtotal3, tax3);
    carpet_cost3 = cost3 * (length3 * width3); 
    area_cost3 = cost3 * (length3 * width3);  
    
    

    printMeasurements(length3, width3);
    printCharges(cost3, labor3, installed_price3, discount3, subtotal3, tax3, total_price3, area_cost3);

    printBox1();
    number = 1;
    printBox2(number, length, width, discount, cost);
    number2 = 2;
    printBox2(number2, length2, width2, discount2, cost2);
    number3 = 3;
    printBox2(number3, length3, width3, discount3, cost3);
